...
class Square extends React.Component {
  ...
  handleClick(e) {
    // if not flipped only then enter to check match and the score
  ...
  render() {
    ...
    // based on value of flipped, show the value of square or the empty square
    var squareValue = this.props.flipped  ? this.props.value : '';
    return (
      //displays the various classes based on flipped and matched values
...
class Game extends React.Component{
  ...
  checkMatch(value, id) {
    ...
    if (this.state.prevSquare) { //if there is a square previously selected before this
      ...
      //if there is no previous square, and locked status
